...
public class XCodeConfig : MonoBehaviour {
    ...
    const string configPath1 = "Assets/xcodeConfig/Editor/XCodeConfigTest.json";
    ...
    private static void FileTest()
    {
        ...
        //string json = File.ReadAllText(configPath1);
        StreamReader streamReader = new StreamReader(configPath1);
        string json = streamReader.ReadToEnd();
        streamReader.Close();
        //Hashtable table = json.hashtableFromJson();
        //table.SSet("teamId", "123");
        //string str = table.hashtableToJson();
        var jToken = JToken.Parse(json);
        JObject jo = jToken as JObject;
        jo["teamId"] = "123";
        string str = jo.ToString();
        //File.WriteAllText(configPath1, str);
        StreamWriter streamWriter = new StreamWriter(configPath1);
